function compareNovels() {
    ...
    let resultHTML = `
                ...
                <div class="comparison-details">
					...
					<p style="top: -10px; position: relative;"><strong>${novel1.chapters}</strong>  ||  <strong>${novel2.chapters}</strong></p>
					<p style="top: -15px; position: relative;">SEGUIDORES</p>
					<p style="top: -25px; position: relative;"><strong>${novel1.followers}</strong>  ||  <strong>${novel2.followers}</strong></p>
					<p style="top: -30px; position: relative;">VISITAS</p>
					<p style="top: -40px; position: relative;"><strong>${novel1.views}</strong>  ||  <strong>${novel2.views}</strong></p>
                </div>
                <div class="novel-info">
